...
PRESET_GROUPS: dict[str, list[dict]] = {
    "科技与AI": [
        ...
        {"name": "Towards Data Science", "url": "https://towardsdatascience.com/feed", "source_type": "rss"},
        {"name": "MarkTechPost", "url": "https://www.marktechpost.com/feed/", "source_type": "rss"},
    ...
    "开发与开源": [
        ...
        {"name": "Python Blog", "url": "https://blog.python.org/feeds/posts/default?alt=rss", "source_type": "rss"},
    ...
    "商业财经": [
        ...
        {"name": "MarketWatch", "url": "https://www.marketwatch.com/rss/topstories", "source_type": "rss"},
